...
DEVICE_INFO = {
    ...
    'flash_page_size_bytes': 0x100, # Note: this represents the optimal transfer size, not actual flash page.
    'flash_write_size_bytes': 4,
    ...
    'calibration_row_read_size_bytes': 4,
